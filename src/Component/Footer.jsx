    ...
    >
      <div className="container mx-auto p-5">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between pt-4 ">
          <p className="text-xs tracking-wide">© 2024. All Rights Reserved</p>
          <p className="text-xs tracking-wide">Development by Lorina</p>
          ...
          <div className="flex items-center gap-2 mt-2 md:mt-0">
           ...
           <a> <LiaLinkedinIn className="text-white p-1 rounded-full bg-mainColor" /></a>
